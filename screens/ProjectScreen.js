                    ...
                    state.projects.list.map((elm) => {
                        return (
                            <View style={{
                                ...
                                <Text style={{ fontSize: 28, fontWeight: 'bold', padding: 10 }}>{elm.nameProject}</Text>
                                <Text style={{ fontSize: 20, fontWeight: 'bold', padding: 10 }}>{elm.description}</Text>
                                <View style={{ width: '100%', height: '50%', backgroundColor: elm.refColor }}>


                                </View>
                                <Text style={{ fontSize: 18, fontWeight: 'bold', padding: 10 }}>Created At: {elm.createdAt} </Text>
                            </View>
