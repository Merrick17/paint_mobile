...
MapboxGL.setAccessToken('pk.eyJ1IjoibWVycmljazE3IiwiYSI6ImNqdjg1d243YjBlbms0NW50M3ZvaGlhbG8ifQ.JvWxv9X81IW7k64zGXEY2Q');
        ...
        <View style={styles.page}>
            <View style={styles.container}>
                ...
                <MapboxGL.MapView style={styles.map} >
                    ...
                    {list && list.map(elm => {
                        //console.log("Eleeemnt", Number(elm.long));
                        if (
                            elm.lat !== null &&
                            elm.lng !== null &&
